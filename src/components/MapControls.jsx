    ...
    <div className="space-y-5">
      <div className="space-y-2">
        <label htmlFor="map-control-city" className="flex items-center gap-2 text-sm font-medium text-blue-200">
          ...
          Città
          <InfoTooltip
            text="Seleziona la città di cui vuoi visualizzare punti luce sulla mappa. Cambiando città verranno caricati solo i dati relativi al comune scelto."
            className="top-0.5"
          />
        </label>
        <MapControlSelect
        ...
        {filterOption === "PROPRIETA" && (
          <div className="flex flex-col gap-2 mt-2">
            ...
            <div className="flex gap-4">
              <label className="inline-flex items-center cursor-pointer min-h-11">
                <input
                  type="radio"
