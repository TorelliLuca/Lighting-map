...
import { ONBOARDING_WIZARD_SLIDES } from "../data/whatsNew"
          ...
          <div className="relative flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-xs font-medium uppercase tracking-wide text-blue-300/80">
                Guida iniziale · {step + 1}/{slides.length}
              </p>
              <h2 id="welcome-wizard-title" className="mt-1 text-xl font-semibold text-white">
                {current.title}
              </h2>
